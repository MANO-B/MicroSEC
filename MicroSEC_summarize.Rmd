...
info_1 = "/mnt/HDD8TB/MicroSEC/source/SL_mutation_somatic_200907.xlsx"
...
#MUTATION_LIST_3 = "/mnt/HDD8TB/MicroSEC/source/summary_1114.tsv"
...
#df_mutation = rbind(df_mutation_1, df_mutation_3, df_mutation_5, df_mutation_match) %>% dplyr::distinct()
...
data_mutations_tmp = data.frame("Number" = "Filter_passing_1234_homopolymer",
                          "FF_N_sample" = length(unique(df_filter_frozen_normal$Sample)),
                          "FFPE_N_sample" = length(unique(df_filter_FFPE_normal$Sample)),
                          "FF_T_sample" = length(unique(df_filter_frozen_tumor$Sample)),
                          "FFPE_T_sample" = length(unique(df_filter_FFPE_tumor$Sample)),
...
data_mutations_tmp = data.frame("Number" = "Filter_passing_1234_notT>C_notHomo",
                          "FF_N_sample" = length(unique(df_filter_frozen_normal$Sample)),
                          "FFPE_N_sample" = length(unique(df_filter_FFPE_normal$Sample)),
                          "FF_T_sample" = length(unique(df_filter_frozen_tumor$Sample)),
                          "FFPE_T_sample" = length(unique(df_filter_FFPE_tumor$Sample)),
...
"Raw_read_no.median" = median(df_summary_frozen_normal$`Raw_read_no.`),
"Raw_read_no.min" = min(df_summary_frozen_normal$`Raw_read_no.`),
"Raw_read_no.max" = max(df_summary_frozen_normal$`Raw_read_no.`),
"Mapped_read_ratio.median" = median(df_summary_frozen_normal$`Mapped_read_ratio%`),
...
"Unique_read_ratio.median" = median(df_summary_frozen_normal$`Unique_read_ratio%`),
...
"Raw_read_no.median" = median(df_summary_FFPE_normal$`Raw_read_no.`),
"Raw_read_no.min" = min(df_summary_FFPE_normal$`Raw_read_no.`),
"Raw_read_no.max" = max(df_summary_FFPE_normal$`Raw_read_no.`),
"Mapped_read_ratio.median" = median(df_summary_FFPE_normal$`Mapped_read_ratio%`),
...
"Unique_read_ratio.median" = median(df_summary_FFPE_normal$`Unique_read_ratio%`),
...
"Raw_read_no.median" = median(df_summary_frozen_tumor$`Raw_read_no.`),
"Raw_read_no.min" = min(df_summary_frozen_tumor$`Raw_read_no.`),
"Raw_read_no.max" = max(df_summary_frozen_tumor$`Raw_read_no.`),
"Mapped_read_ratio.median" = median(df_summary_frozen_tumor$`Mapped_read_ratio%`),
...
"Unique_read_ratio.median" = median(df_summary_frozen_tumor$`Unique_read_ratio%`),
...
"Raw_read_no.median" = median(df_summary_FFPE_tumor$`Raw_read_no.`),
"Raw_read_no.min" = min(df_summary_FFPE_tumor$`Raw_read_no.`),
"Raw_read_no.max" = max(df_summary_FFPE_tumor$`Raw_read_no.`),
"Mapped_read_ratio.median" = median(df_summary_FFPE_tumor$`Mapped_read_ratio%`),
...
"Unique_read_ratio.median" = median(df_summary_FFPE_tumor$`Unique_read_ratio%`),
