...
data_matched_tmp = data.frame("Number" = "Filtered_mutations_not_T>C",
                          "FF_only" = data_matched$FF_only[1] - (dim(df_filter_frozen_tumor %>% dplyr::filter(Sample %in% matched_frozen))[1] - dim(df_matched)[1]),
                          "FF_and_FFPE"= data_matched$FF_and_FFPE[1] - dim(df_matched)[1],
                          "FFPE_only" = data_matched$FFPE_only[1] - (dim(df_filter_FFPE_tumor %>% dplyr::filter(Sample %in% matched_FFPE))[1] - dim(df_matched)[1]))
