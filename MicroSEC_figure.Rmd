...
g = ggplot(data=df) +
  ...
  scale_y_continuous(breaks=seq(0,120,20), limits=c(0,120), sec.axis = sec_axis(~ . / second_rate, name = "Filtered rate (%)")) +
...
g = g + ylab("Mutations")
g = g + geom_vline(xintercept=30, linetype="dashed", colour="red")
g = g + ggtitle("FFPE samples of normal breast tissue")
g = g +scale_x_continuous(breaks=seq(0,100,by=20),limits=c(0,100))
