...
g = ggplot() +
  ...
  ggtitle("Coverage and filtering rate") + 
  ...
  theme(panel.grid.minor = element_line(colour = "black", size = 0, linetype="dotted")) +
...
ggsave(paste(wd, "/output/coverage_", Sys.Date(), ".pdf", sep=""), plot=g, width=12, height=8)
